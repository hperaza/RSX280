1 PRINT "CRAP GAME WITH THE COMPUTER AS YOUR OPPONENT."
2 PRINT "THE RULES ARE SIMPLE:"
...
106 PRINT "THANKS FOR THE GAME... BETTER LUCK NEXT TIME, PARTNER!"
107 GO TO 110 
