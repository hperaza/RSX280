...
170 PRINT "AND SOMEONE'S LAST NAME";\INPUT G$
180 PRINT "A GEOGRAPHICAL LOCATION";\INPUT H$
190 PRINT "A LIQUID";\INPUT I$
200 PRINT "AND FINALLY, AN EXCLAMATORY WORD OR TWO";\INPUT J$\PRINT 
220 PRINT "VERY GOOD!  WOULD YOU LIKE A NEWSPAPER AD (1),"
230 PRINT "A WESTERN (2), A STORY ABOUT THE ARMY (3), OR"
240 PRINT "A WATERBED (4).  WHICH ONE, 1, 2, 3, OR 4";\INPUT N\PRINT 
250 IF N>0 THEN IF N<5 THEN 270
260 PRINT "COME ON NOW -- 1, 2, 3, OR 4";\INPUT N\GOTO 250
270 FOR I=1 TO 6\PRINT\NEXT I\ON N GOTO 300,400,500,600
...
700 FOR I=1 TO 6\PRINT\NEXT I\PRINT "WANT ANOTHER STORY (YES OR NO)";\INPUT Y$
710 IF Y$="NO" THEN 900
720 PRINT "WANT TO USE THE SAME WORDS (YES OR NO)";\INPUT Y$\PRINT 
730 IF Y$="YES" THEN 220
731 IF Y$="NO" THEN 60
740 PRINT "COME ON NOW -- 'YES' OR 'NO'";\INPUT Y$\PRINT \GOTO 730
