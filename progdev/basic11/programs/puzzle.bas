...
20 REM   *** CREATED BY MICHAEL KASS   HERRICKS HS, NY
30 PRINT "THE OBJECT OF THIS PUZZLE IS TO CHANGE THIS:"
40 PRINT 
50 PRINT "X X X X X X X X X X"
60 PRINT 
70 PRINT "TO THIS:"
80 PRINT 
90 PRINT "O O O O O O O O O O"
100 PRINT 
110 PRINT "BY TYPING IN THE NUMBER CORRESPONDING TO THE POSITION OF THE LETTER"
120 PRINT "ON SOME NUMBERS, ONE POSITION WILL CHANGE; ON OTHERS, TWO WILL CHANGE."
130 PRINT "TO RESET A LINE TO ALL X'S, TYPE 0 (ZERO) AND TO START A NEW PUZZLE"
140 PRINT "IN THE MIDDLE OF A GAME, TYPE 11 (ELEVEN)."
150 PRINT  \ PRINT "UNFORTUNATELY, SOME OF THESE PUZZLES DO NOT HAVE A SOLUTION!" \ PRINT 
160 PRINT  \ DIM A$(20)
170 DEF FNT(X)=SIN(X)/COS(X) \ REM TANGENT
180 RANDOMIZE
190 LET Q=RND
...
410 LET A$(N)="O"
420 LET R=FNT(Q+N/Q-N)-SIN(Q/N)+336*SIN(.8*N)
430 LET N=R-INT(R)
440 LET N=INT(10*N)
...
520 LET A$(N)="O"
530 R=.592/FNT(Q/N+Q)/SIN(N*2+Q)-COS(N)
540 LET N=R-INT(R)
550 LET N=INT(10*N)
...
730 INPUT X$
740 IF X$="NO" THEN 770
750 PRINT 
760 GO TO 190
770 PRINT  \ PRINT "OKAY.  SO LONG FOR NOW." \ PRINT  \ END
