1 REM   *** WRITTEN BY JIM STORER, LEXINGTON HS -- MODIFIED BY DAVE AHL, DEC
...
48 PRINT
49 NEXT Y1
50 LET A=INT(60000+(RND*1000)-(RND*1000))
55 LET B=INT(500+(RND*10)-(RND*10))
65 LET D=2000
100 LET W=INT(RND*10+95)
101 FOR Y1=1 TO 2
102 PRINT
103 NEXT Y1
105 PRINT "YOU NOW HAVE";A;"RALLODS IN THE TREASURY."
110 PRINT INT(B);"COUNTRYMEN,";
115 LET V9=INT(((RND/2)*10+10))
120 IF C=0 THEN 140
...
1220 LET C1=INT(H+(RND*10)-(RND*20))
...
1290 LET B=INT(B+P1)
1292 LET C=INT(C+C1)
1305 LET U2=INT(((2000-D)*((RND+1.5)/2)))
...
1390 LET A=INT(A+Q)
1400 LET V1=INT(((B-P1)*22)+(RND*500))
