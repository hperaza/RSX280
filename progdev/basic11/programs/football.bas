...
630 GOSUB 2250
640 LET F1=50
650  LET B=INT(F1+O*20*RND+(1-O)*29*(2-RND^7-RND^(3-Z2)))
660 LET O=0
670 LET Z9=8
680 GOSUB 1490
690 LET L=0
...
1000	LET C=INT(C-L*(5+2*RND))
1010 LET L=1
1020 IF M=7 THEN 1760
1030 IF M=8 THEN 1920
1040 LET Y1=Y-1
1050	IF RND > Z(M-1,Y1) THEN 1240
1060 LET A=2
1070 GOSUB 3020
1080 IF M<4 THEN 1110
1090 PRINT "PASS COMPLETE..";
1100	LET L = SGN (INT(4*RND))
1110	IF RND < F2 THEN 2510
...
1260 GOSUB 3020
1270 GOTO 1120
1280	IF RND < .06*(2-SGN(Y-3)) THEN 1360
1290	IF RND < .05+INT(Y/3.5)/5 THEN 1510
1300 LET Z9=6
1310 GOSUB 1490
...
1470 PRINT "AT ";
1480 GOTO 2360
1490	LET C = C-INT(4+Z9/2*(1+RND))
1500 RETURN
1510	LET G = -(5+INT(10*RND))
1520 PRINT "THE QUARTERBACK ";
1530	IF RND > .5 THEN 1560
...
1690	IF RND < .5 THEN 3120
1700 PRINT "**MEASUREMENT**"
1710 GOSUB 3520
1720	IF RND < .5 THEN 3120
1730 GOSUB 2980
1740 LET D=0
1750 GOTO 3120
1760	IF RND < .06 THEN 1890
1770	LET B=B+30+INT(15*(1-RND^3))
1780 LET Z9=2
1790 GOSUB 1490
...
1900	LET G = -INT(14*RND)
1910 GOTO 1410
1920 PRINT "THE PUNT IS ";
1930	IF RND < .06 THEN 1890
1940 LET F1=B
1950 LET Z2=1
1960 LET S=3-S
1970 LET Z3=.65
...
2360 GOSUB 3300
2370	IF Z2*RND > Z3 THEN 2490
2380	IF RND < F2 THEN 2500
2390	LET G = 5+INT(100*RND)
2400	IF RND < .15 THEN 2430
2410	LET G = INT(24*(1-RND^2))
...
2470 PRINT " TO ";
2480 GOSUB 3300
2490	IF RND > F2 THEN 3260
2500 LET G=0
2510 PRINT "**FUMBLE**";
2520 GOTO 1410
2530 IF S=1 THEN 2560
2540	LET Y = INT(1+3.5*RND)
2550 RETURN
2560	LET M = INT(55*RND/10.5)+1
2570 IF (B1-B)/(5-D)<3 THEN 2590
2580	LET M = INT(6-4*RND^2)
2590 IF L*F*60>=C THEN 2670
2600 IF D<4 THEN 2550
2610 PRINT "I'LL ";
2620 IF B<55 THEN 2720
2630	IF 0 < 4*RND-B1+B THEN 2750
...
3090	LET G = G+INT(RND+.02)*A*100*RND
3100 LET G=INT(G)
3110 RETURN
3120 LET D=D+1
