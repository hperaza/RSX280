...
2660 PRINT CHR$(7);"RIGHT BETWEEN THE EYES---YOU GOT A BIG ONE!!!!"
...
5470 PRINT CHR$(7);"YOU FINALLY ARRIVED AT OREGON CITY"
5480 PRINT CHR$(7);"AFTER 2040 LONG MILES---HOORAY!!!!!"
...
6210 B3=60*VAL(SEG$(CLK$,4,5))+VAL(SEG$(CLK$,7,8))
6220 INPUT C$
6230 B1=60*VAL(SEG$(CLK$,4,5))+VAL(SEG$(CLK$,7,8))
6240 B1=(B1-B3)-(D9-1)
6250 PRINT
