...
1540 PRINT "YOU'RE STARTING WITH $1000; I HAVE $100,000 IN THE BANK"
...
1640 INPUT Y
1650 IF Y<1 THEN 1630
1651 IF Y<>INT(Y) THEN 1630
1660 FOR I=1 TO 50
1662 LET A(I)=0
1664 NEXT I
1670 FOR C=1 TO Y
1680 PRINT "ENTER BET NUMBER";C;" AS   N,M  ";
1690 INPUT X,Z
1700 B(C)=Z
1710 T(C)=X
1720 IF X<1 THEN 1680
1721 IF X>50 THEN 1680
1722 IF X<>INT(X) THEN 1680
1730 IF Z<1 THEN 1680
1731 IF Z<>INT(Z) THEN 1680
1740 IF Z<5 THEN 1680
1741 IF Z>500 THEN 1680
...
1840 IF S=0 THEN 1830
1841 IF S>38 THEN 1830
1850 X(S)=X(S)+1
...
2041 IF T(C)>48 THEN 2710
2050 ON T(C)-36 GOTO 2090,2190,2220,2250,2300,2350,2400,2470,2500,2530,2560,2630
2070 GOTO 2710
2080 STOP 
...
2200 IF S>12 THEN IF S<25 THEN 2150
2210 GOTO 2110
2220 REM  25-36(39) 2:1
2230 IF S>24 THEN IF S<37 THEN 2150
2240 GOTO 2110
...
2480 IF S<37 THEN IF S>18 THEN 2430
2490 GOTO 2110
2500 REM  EVEN(45) 1:1
2510 IF S/2=INT(S/2) THEN IF S<37 THEN 2430
2520 GOTO 2110
2530 REM  ODD(46) 1:1
2540 IF S/2<>INT(S/2) THEN IF S<37 THEN 2430
2550 GOTO 2110
2560 REM  RED(47) 1:1
2570 RESTORE 
2580 FOR I=1 TO 18
...
2730 IF T(C)=49 THEN IF S=37 THEN 2780
2740 IF T(C)=50 THEN IF S=38 THEN 2780
2750 GOTO 2110
...
3020 PRINT 
3040 PRINT TAB(40);DAT$
3050 PRINT 
3060 PRINT 
3070 PRINT " PAY TO THE ORDER OF  ";B$;TAB(45);"$ ";P
3075 PRINT "                     ---------------"
3100 PRINT 
