...
310 LET Z=INT(6*RND+1)
320 C=1
330 PRINT "YOU ROLLED A ";Z
340 ON Z GO TO 350,430,540,650,760,870
350 PRINT "1=BODY"
360 IF B=1 THEN 410
...
970 LET X=INT(6*RND+1)
980 PRINT "I ROLLED A ";X
990 ON X GO TO 1000,1080,1190,1300,1410,1520
1000 PRINT "1=BODY"
...
1620 GO TO 1630
1630 IF A=2 THEN IF T=1 THEN IF L=6 THEN 1650
1640 GO TO 1670
1650 PRINT "YOUR BUG IS FINISHED"
1660 LET Y=Y+1
1670 IF S=2 THEN IF P=1 THEN IF V=6 THEN 1690
1680 GO TO 1710
